nextflow.enable.dsl=2
     ...
     params.data="/home/host_home/RNAseq_splicing_pipeline/sample_fastqs/*R{1,2}*.fastq.gz"
...
include { gtf_to_ref_flat } from './modules/GtfToRefFlat'
...
// Picard and Qualimap QC modules. They provide QC data on STAR alignment which can be used to detect problematic samples and for covariate/outlier detection.
gtf_to_ref_flat(genome_download.out.gtf)
picard_mult(sam_sort_index.out.sorted_bams, genome_download.out.fasta)
picard_gc(sam_sort_index.out.sorted_bams, genome_download.out.fasta)
picard_rnaseq(sam_sort_index.out.sorted_bams, gtf_to_ref_flat.out.ref_flat)
qualimap(sam_sort_index.out.sorted_bams, genome_download.out.gtf)
